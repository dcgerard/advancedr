...
- Here is are the microbenchmarks:
...
XYZ Do chapter 19 of Rcpp for Everyone

# Missing Values

XYZ Do chapter 24 of Rcpp for Everyone
...
3. (from Advanced R) Convert the following functions into C++. For now, assume the inputs have no missing values.
    1. `all()`.
