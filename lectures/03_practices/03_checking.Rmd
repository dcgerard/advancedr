...
- I wouldn't run `devtools::check()` everytime you make a change. I would do it only a couple times a day. But the earlier you do it, the easier it is to fix all issues.
...
- Failure to have a package installed: This hapens sometimes when you work on multiple computers (or collaborate with others). You can install all dependencies of a package with
    ```{r, eval = FALSE}
