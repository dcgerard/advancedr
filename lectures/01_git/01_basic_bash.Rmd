...
- Open up the terminal
    ...
    - Mac: On your Mac, do one of the following:
        - Click the Launchpad icon <img src="./figs/launchpad.png" alt="Mac Launchpad icon" width="20" height="20"> in the Dock, type Terminal in the search field, then click Terminal.
        - In the Finder <img src="./figs/finder.png" alt="Mac Finder Icon" width="20" height="20">, open the /Applications/Utilities folder, then double-click Terminal.
