...
- Open up the terminal
    - Windows: Open up the `Git Bash` app. It should look like this:
        ...
        <img src="./figs/git_bash.png" alt="Git Bash for Windows" width="50%"/>
        
    - Mac: On your Mac, do one of the following:
        - Click the Launchpad icon <img src="https://help.apple.com/assets/5FFCB3EC94BE2A0CD2446152/5FFCB3ED94BE2A0CD2446159/en_US/a1f94c9ca0de21571b88a8bf9aef36b8.png" alt="Launchpad icon" originalimagename="SharedGlobalArt/AppIconTopic_Launchpad.png" width="20" height="20"> in the Dock, type Terminal in the search field, then click Terminal.
        - In the Finder <img src="https://help.apple.com/assets/5FFCB3EC94BE2A0CD2446152/5FFCB3ED94BE2A0CD2446159/en_US/058e4af8e726290f491044219d2eee73.png" alt="" originalimagename="SharedGlobalArt/AppIconTopic_Finder.png" width="20" height="20">, open the /Applications/Utilities folder, then double-click Terminal.
    - Ubuntu: Do one of the following
        ...
        - It should look like this:
            ...
            <img src="./figs/terminal_ubuntu.png" alt="Git Bash for Windows" width="50%"/>
