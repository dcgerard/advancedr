...
- Go to [Add Public Key to GitHub](https://dcgerard.github.io/advancedr/01_git_github.html#add-public-key-to-github) to continue authentication setup.
...
1. On [GitHub](https://github.com/), in the upper right corner, click on your profile photo and click on "Settings"
