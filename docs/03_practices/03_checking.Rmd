...
2. It is probably difficult for the user to specify both $\sigma^2$ (the residual variance) and $\tau^2$ (the variance of the predictors). A better API would allow the user to provide more intuitive inputs. One possible input would be the proportion of variance explained (PVE), which we will define as
    $$
