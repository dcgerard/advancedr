...
The data in the VCF file XYZ contain a very subset of the data from @euclide2020attack, downloaded from \<[doi:10.5061/dryad.3mq4631](https://doi.org/10.5061/dryad.3mq4631)\>. Let's use the `{VariantAnnotation}` package to play around with it.
