...
2. Write a function called `quadform()` in C++ that prints the output (usine `Rcpp::Rcout`) of the [quadratic formula](https://en.wikipedia.org/wiki/Quadratic_formula). That is
    $$
